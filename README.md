...
- Python 3.9+ (currently doesn't work with 3.12)
- Git
...
4. Install IBMFL from the repo (currently does not work on Python 3.12)

    - Install necessary packages for IBM's federated learning library:
   ...
   <!-- Add Mac/Windows equivalent commands -->

    - From `Anylog-Edgelake-CSE115D/`, navigate to `federated-learning-lib-main/federated-learning-lib`
        and run the following to install IBM's FL library:
