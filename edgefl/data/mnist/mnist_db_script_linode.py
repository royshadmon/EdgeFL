...
def create_node_table(conn, cur, node_name):
...
def insert_round_data(conn, cur, table_name, round_num, images, labels, data_type):
...
def main():
    ...
    db_ips = ["172.236.100.105", "172.234.250.196", "198.74.58.196"]
    ...
    try:
        ...
        for node in range(1, NUM_NODES + 1):
            ...
            table_name = create_node_table(conn, cur, node_name)
            ...
            for round_num in range(1, NUM_ROUNDS + 1):
                ...
                insert_round_data(conn, cur, table_name, round_num, train_images, train_labels, 'train')
                train_idx = train_end
                ...
                insert_round_data(conn, cur, table_name, round_num, test_images, test_labels, 'test')
                test_idx = test_end
