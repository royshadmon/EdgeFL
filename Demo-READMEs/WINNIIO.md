...
```bash
curl -X POST http://localhost:8081/inference/fl-winniio ; curl -X POST http://localhost:8082/inference/fl-winniio ; curl -X POST http://localhost:8083/inference/fl-winniio
